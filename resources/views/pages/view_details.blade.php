   ...
   @media (max-width: 768px) {
       ...
       @media (max-width: 474px) {
        ...
        .main-image{
         ...
         .sub-btn .reserve-btn, .add-cart-btn, .wishlist-btn{
          width: 100px;
...
<div id="nav-bar">
  ...
  <div id="nav-content">
    ...
    <div class="nav-button"><a href="{{ url('student/announcement') }}" style="text-decoration: none; color: inherit;">
        ...
        </svg><span>Announcements</span></a><span id="reservation-badge" class="badge bg-warning text-dark" style="display: none;">New</span>
    </div>
    ...
    <div class="wrapper">
      <div class="image-container">
        <div class="small-image-container">
          @foreach ($deptData as $deptt)
          <div class="image-wrapper">
            <img
              class="sub-image"
              src="{{asset('../' . $deptt->sub_image_url) }}"
               data-id="{{$deptt->id}}"
      ...
      <div class="details">
        ...
        <div class="dept-list">
          ...
          @forelse($deptData as $department)
            ...
            <option class="option" data-id="{{ $department->id }}" 
            ...
            changeImage(this)">{{ $department->variation_type }}</option>
        ...
        <div class="size-list">
          ...
          @forelse($sizeData as $size)
              ...
              data-variationSizeId="{{ $size->product_variation_id }}"
        ...
        <div class="qty qty1" style="display:flex">
          ...
          <div class="sub-btn">
           ...
           <button type="submit" name="action" style="display:none" class="wishlist-btn" value="add_to_wishlist">
