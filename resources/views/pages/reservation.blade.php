  ...
  <form action="{{ url('student/reservation')}}" method="post">
    ...
    <table>
      ...
      <tr>
        ...
        <td><span data-id="{{$d->id}}" style="color: #a80000" class="cancel-btn">Cancel</span></td>
...
<div class="bottom-nav">
    ...
    <div class="cancel-card">
      ...
      <div class="card-button-wrapper">
        ...
        <a id="delete-link" href="#" class="card-button primary" style="text-align:center; display: flex; justify-content: center; align-items:center;"> Yes, Cancel Item</a>
      </div>
